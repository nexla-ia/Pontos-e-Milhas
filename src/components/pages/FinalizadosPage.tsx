...
export default function FinalizadosPage() {
  ...
  const loadOrders = async () => {
    try {
      ...
      // Buscar pedidos com status "done" e fazer join com users e agencies
    ...
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <nav className="text-sm text-gray-600">
          ...
          <span className="mx-2">›</span>
          <span className="text-gray-900 font-medium">Finalizados</span>
        </nav>
            ...
            {currentItems.length === 0 ? (
              <tr>
                <td colSpan={10} className="px-6 py-8 text-center text-gray-500">
                  Nenhuma OP finalizada encontrada
                </td>
              </tr>
            ) : (
      ...
      <div className="mt-4 text-sm text-gray-600">
        Total de OPs finalizadas: {totalItems}
      </div>
    </div>
  );
}